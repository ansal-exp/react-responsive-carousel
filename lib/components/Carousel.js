...
var Carousel = (function(_Component) {
    ...
    function Carousel(props) {
        ...
        _this.autoPlay = function() {
            if (
                !_this.state.autoPlay ||
                _react.Children.count(_this.props.children) <= 1
            ) {
                return;
            }
        ...
        _this.updateSizes = function() {
            ...
            _this.setState({
                ...
                wrapperSize: isHorizontal
                    ? itemSize * _react.Children.count(_this.props.children)
                    : itemSize
            });
        ...
        _this.onSwipeMove = function(delta) {
            ...
            var finalBoundry = _this.getPosition(
                _react.Children.count(_this.props.children) - 1
            );

            var axisDelta = isHorizontal ? delta.x : delta.y;

            // axisDelta should be 0 if the swipe is not intended in the preffered direction
            if (isHorizontal)
                axisDelta =
            ...
            // prevent small unintended swipes from moving the slider; 40 is just an offset
            if (Math.abs(axisDelta) < 40) axisDelta = 0;
            ...
            var position =
                currentPosition +
                100 / (_this.state.itemSize / handledDelta) +
                "%";
            ...
            var hasMoved =
                Math.abs(axisDelta) > _this.props.swipeScrollTolerance;
        ...
        _this.setPosition = function(position) {
            ...
            [
                ...
                list.style[prop] = (0, _CSSTranslate2.default)(
                    position,
                    _this.props.axis
                );
            });
        ...
        _this.resetPosition = function() {
            var currentPosition =
                _this.getPosition(_this.state.selectedItem) + "%";
        ...
        _this.selectItem = function(state) {
            ...
            _this.handleOnChange(
                state.selectedItem,
                _react.Children.toArray(_this.props.children)[
                    state.selectedItem
                ]
            );
        };
    ...
    _createClass(Carousel, [
        ...
        },
        {
            ...
            value: function unbindEvents() {
                ...
                var initialImage = this.getInitialImage();
                if (initialImage) {
                    initialImage.removeEventListener(
                        "load",
                        this.setMountState
                    );
                }
        ...
        },
        {
            ...
            value: function getPosition(index) {
                if (this.props.centerMode && this.props.axis === "horizontal") {
                    var currentPosition =
                        -index * this.props.centerSlidePercentage;
                    var lastPosition =
                        _react.Children.count(this.props.children) - 1;
        ...
        },
        {
            ...
            value: function renderItems() {
                ...
                return _react.Children.map(this.props.children, function(
                    item,
                    index
                ) {
                    ...
                    var slideProps = {
                        ...
                        key: "itemKey" + index,
                        className: _cssClasses2.default.ITEM(
                            true,
                            index === _this3.state.selectedItem
                        ),
                        onClick: _this3.handleClickItem.bind(
                            _this3,
                            index,
                            item
                        )
                    ...
                    if (
                        _this3.props.centerMode &&
                        _this3.props.axis === "horizontal"
                    ) {
                        slideProps.style = {
        ...
        },
        {
            ...
            value: function renderControls() {
                ...
                return _react2.default.createElement(
                    ...
                    _react.Children.map(this.props.children, function(
                        item,
                        index
                    ) {
                        return _react2.default.createElement("li", {
                            className: _cssClasses2.default.DOT(
            ...
            value: function render() {
                ...
                if (isHorizontal) {
                    ...
                    if (this.props.dynamicHeight) {
                        var itemHeight = this.getVariableImageHeight(
                ...
                return _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement("button", {
                            type: "button",
                            className: _cssClasses2.default.ARROW_PREV(
                                !hasPrev
                            ),
                        ...
                        _react2.default.createElement(
                            "div",
                            {
                                className: _cssClasses2.default.WRAPPER(
                                    true,
                                    this.props.axis
                                ),
                        ...
                        _react2.default.createElement("button", {
                            type: "button",
                            className: _cssClasses2.default.ARROW_NEXT(
                                !hasNext
                            ),
